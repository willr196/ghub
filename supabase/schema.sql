...
-- Daily Log table (FIXED: composite unique constraint on user_id + date)
...
-- Travel/Places visited table (NEW - integrated from separate file)
...
-- Travel policies (public viewable, owner editable)
